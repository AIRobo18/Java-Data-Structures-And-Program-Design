...
public class DirectedGraph<T> implements GraphInterface<T>
{
    ...
    public VertexInterface<T> getMainUserVertex(T user)
    {
        VertexInterface<T> mainUser = this.vertices.get(user);
        return mainUser;
    }
...
//        System.out.println("IMPLEMENT getDepthFirstTraversal method");
        ...
        this.vertices.get(origin).visit();
        traversalOrder.offer(this.vertices.get(origin).getLabel());
        vertexStack.push(this.vertices.get(origin));
...
//        System.out.println("IMPLEMENT getCheapestPath method");
        ...
        while (!done && !priorityQueue.isEmpty())
        {
            ...
            if (!frontVertex.isVisited())
            {
                ...
                {
                    Iterator<VertexInterface> iteratorNeighbor = frontVertex.getNeighborIterator();
                    Iterator<Double> iteratorEdge = frontVertex.getWeightIterator();
                    while (iteratorNeighbor.hasNext() && iteratorEdge.hasNext())
                    {
                        VertexInterface nextNeighbor = iteratorNeighbor.next();
                        double weightOfEdgeToNeighbor = (double)iteratorEdge.next();
