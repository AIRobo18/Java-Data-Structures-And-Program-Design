...
//        System.out.println("IMPLEMENT kthItem METHOD RECURSIVELY");
        ...
        // int check is partition(a, first, last)
        // IF check equals k
        //     return a[check]
        // ELSE IF check > k
        //     partition(a, first, check)
        // ELSE IF check < k
        //     partition(a, check, last)
    ...
    public static void main(String args[])
    {
        ...
        for (int i = 1; i <= trials; i++)
        {
            ...
            //SortArray.quickSort(forTesting, arraySize);
            ...
            for (int k = 0; k < arraySize; k++)
            {
                ...
                // we want to test the code as much as possible but the following case is what we are interested in
                if (k == (arraySize / 2))
                {
