...
public class MinInArray
{
    ...
    public static int minimum(int[] data, int first, int last)
    {
        ...
        if ((data == null) || (first > last) || (first < 0) || (data.length == 0) || (last == data.length))
        {
            throw new BadArgumentsForMinimumException("Invalid index");
        }
...
//            System.out.println("The mid data is: " + data[mid]);
            ...
            minimum(data, first, mid);
            minimum(data, mid + 1, last);
        }
