...
public class SortArray
{
    ...
    void shellSortWithNoEvenStep(T[] a, int first, int last)
    {
        ...
        {
            if (step % 2 == 0) // if step is even, add 1
                step++;
...
//        System.out.println("IN improvedBubbleSort METHOD - IMPLEMENT ME");
        ...
        startStatistics();
        while (leftIndex < rightIndex && swap)
        {
            swap = false;
            for (int index = leftIndex; index < rightIndex; index++)
            {
    ...
    void shakerImprovedBubbleSort(T[] a)
    {
        ...
        System.out.println("IN shakerImprovedBubbleSort METHOD - IMPLEMENT ME");
        ...
        while (leftIndex < rightIndex && swap)
        {
            ...
            rightIndex = newRight;
            for (int endIndex = rightIndex; (endIndex > leftIndex) && swap; endIndex--)
            {
                comparisons++;
                if (a[endIndex].compareTo(a[endIndex - 1]) < 0)
                {
//                    swap = true;
                    swap(a, endIndex - 1, endIndex);
                    newLeft = endIndex;
                }
            }
            leftIndex = newLeft;
    ...
    {
//        System.out.println("IN reverseOrder - IMPLEMENT ME");
...
//        System.out.println("IN generateRandomArray - IMPLEMENT ME");
